  ...
  return (
    <div className="flex" style={{ minHeight: '100vh', background: 'var(--bg-base)' }}>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {header}
        {/* No `relative`/`overflow` here in the vendored copy: Quotation Center's
            print output (#quotation-print, position:absolute) and any fixed-position
            modals must keep positioning relative to the viewport, not this wrapper. */}
